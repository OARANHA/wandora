...
Core/Paperclip/Gateway were unchanged. MEDICSPRO grounding = 0, works = 2, outbound = 0, Ana = active + supervised, Human Send/Gateway outbound = OFF.

Next product/effect work should start from this live state. The already-authorized first MEDICSPRO grounding execution still requires the normal authenticated owner/admin customer flow.
