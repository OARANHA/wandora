...
5. ADR 0086 proves the next rollout prerequisite is Customer Owner Invite Acceptance + First Password Contract Implementation V1; keep public signup OFF, reuse Supabase Auth credentials/invites, and do not create a synthetic tenant merely to obtain an eligibility target;
