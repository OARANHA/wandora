...
5. ADR 0090 closes the owner invite+recovery activation preflight but blocks Web promotion on anti-abuse; next prove the narrowest compatible Cloudflare recovery control (or a separately reviewed provider-native CAPTCHA contract) before any owner-access deployment or real recovery request;
