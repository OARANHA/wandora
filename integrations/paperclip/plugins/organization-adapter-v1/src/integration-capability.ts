import type {
  PluginContext,
  PluginToolAccessOperationalConnection,
  PluginToolAccessOperationalSnapshot,
  PluginToolAccessOperationalTool,
...
function providerReadSemantic(tool: PluginToolAccessOperationalTool): boolean {
...
function operationallyAvailableReadTool(tool: PluginToolAccessOperationalTool): boolean {
...
function normalizeHealth(
  runtimeHealth: PluginToolAccessOperationalSnapshot['runtimeHealth'],
  connection: PluginToolAccessOperationalConnection,
...
export function normalizePaperclipOperationalSnapshot(
  snapshot: PluginToolAccessOperationalSnapshot,
