...
- ADR 0103 closes the first real tenant provisioning preflight: the exact MEDICSPRO V2 request, deterministic slug/request key, hashed Auth-subject gate, least-privilege execution identity, replay rules and postconditions are frozen. No tenant exists yet; execution must reuse V2 exactly and stop before Paperclip/provider/eligibility/hire effects.
