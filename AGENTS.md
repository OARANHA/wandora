...
- ADR 0077 freezes the first live customer-hire proof on a private Core candidate: provenance-verified candidate image, no public ingress, real human Supabase owner session, stable canary idempotency/replay contract, paused-first expectations and mandatory candidate cleanup.
